...
class InputValidator {
    ...
    void validate(Input input) {
        switch (input) {
            ...
            case splashInIncorrectFormat             : throw new InputValidationException("The 'splash' parameter points to a file with an invalid file type - only bmp, jpg, wbmp, jpeg, or gif files are supported.")
        }
    }
