...
import static te.g2exe.input.core.parameterValidators.AppTypeValidator.getConsoleAndGuiFlagsBothSet
import static te.g2exe.input.core.parameterValidators.DestDirValidator.getDestDirDoesNotExistOrIsNotDir
import static te.g2exe.input.core.parameterValidators.FileToConvertValidator.getFileToConvertIsIncorrectFileType
import static te.g2exe.input.core.parameterValidators.FileToConvertValidator.getFileToConvertIsMissing
import static te.g2exe.input.core.parameterValidators.HeapSizeValidator.*
import static te.g2exe.input.core.parameterValidators.IconFileValidator.getIconDoesNotExistOrIsNotFile
import static te.g2exe.input.core.parameterValidators.IconFileValidator.getIconInIncorrectFormat
import static te.g2exe.input.core.parameterValidators.JreVersionValidator.getMinJreInInvalidFormat
import static te.g2exe.input.core.parameterValidators.SplashFileValidator.getSplashDoesNotExistOrIsNotFile
import static te.g2exe.input.core.parameterValidators.SplashFileValidator.getSplashInIncorrectFormat
import static te.g2exe.input.core.parameterValidators.TempDirValidator.*
...
class InputValidator {
    ...
    private static void validateOptionalParameters(Input input){
        switch (input) {
            ...
            case splashInIncorrectFormat             : throw new InputValidationException("The 'splash' parameter points to a file with an invalid file type - only bmp, jpg, jpeg, or gif files are supported.")
        }
    }
